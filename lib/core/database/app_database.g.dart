...
class $AlbumsTable extends Albums with TableInfo<$AlbumsTable, Album> {
  ...
  static const VerificationMeta _telegramTopicIdMeta = const VerificationMeta(
    'telegramTopicId',
  );
  @override
  ...
  Album map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Album(
      ...
      telegramTopicId: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}telegram_topic_id'],
      ),
...
class $MediaItemsTable extends MediaItems
  ...
  static const VerificationMeta _telegramMsgIdMeta = const VerificationMeta(
    'telegramMsgId',
  );
  @override
  ...
  MediaItem map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return MediaItem(
      ...
      telegramMsgId: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}telegram_msg_id'],
      ),
...
class MediaItem extends DataClass implements Insertable<MediaItem> {
  ...
  factory MediaItem.fromJson(
    ...
    return MediaItem(
      ...
      uploadStatus: $MediaItemsTable.$converteruploadStatus.fromJson(
  ...
  MediaItem copyWith({
    ...
    telegramMsgId: telegramMsgId.present
        ? telegramMsgId.value
        : this.telegramMsgId,
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final Index idxCapturedAt = Index(
    'idx_captured_at',
                  ...
                  if (mediaItemsRefs)
                    await $_getPrefetchedData<Album, $AlbumsTable, MediaItem>(
                      ...
                      managerFromTypedResult: (p0) =>
                          $$AlbumsTableReferences(db, table, p0).mediaItemsRefs,
...
final class $$MediaItemsTableReferences
  ...
  static $AlbumsTable _albumIdTable(_$AppDatabase db) => db.albums.createAlias(
    $_aliasNameGenerator(db.mediaItems.albumId, db.albums.id),
  );
