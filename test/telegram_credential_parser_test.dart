...
''';
    ...
    test('3. Parses JSON format', () {
      const input = '{"api_id": 9876543, "api_hash": "b18441a1b608e3cdeec510d3f026fb29"}';
      final result = TelegramCredentialParser.parse(input);
      expect(result.isValid, isTrue);
    ...
    test('5. Parses individual standalone hash or ID', () {
      ...
      final singleHash = TelegramCredentialParser.parse('8da85b0d5b1652522bc46057082da478');
    ...
    test('6. Handles empty or garbage text safely', () {
      final result = TelegramCredentialParser.parse('hello world this is not valid');
